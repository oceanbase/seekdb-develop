...
#define CLUSTER_VERSION_1_3_0_0 (oceanbase::common::cal_version(1, 3, 0, 0))
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//TODO: If you update the above version, please update CLUSTER_CURRENT_VERSION.
#define CLUSTER_CURRENT_VERSION CLUSTER_VERSION_1_3_0_0
...
#define DATA_VERSION_1_3_0_0 (oceanbase::common::cal_version(1, 3, 0, 0))
#define DATA_CURRENT_VERSION DATA_VERSION_1_3_0_0
// ATTENSION !!!!!!!!!!!!!!!!!!!!!!!!!!!
// LAST_BARRIER_DATA_VERSION should be the latest barrier data version before DATA_CURRENT_VERSION
#define LAST_BARRIER_DATA_VERSION DATA_VERSION_1_3_0_0
