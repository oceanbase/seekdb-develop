...
// HNSW heap + async: avoid varchar_col_total_length exceeding OB_MAX_USER_ROW_LENGTH
const int64_t OB_MAX_LOB_INROW_THRESHOLD_FOR_VEC_ASYNC_INDEX = OB_MAX_LOB_INROW_THRESHOLD / 10;
