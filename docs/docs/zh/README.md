...
1. **开始**: 设置开发环境，构建和连接到OceanBase SeekDB服务器，子部分基于一个想象的新手用户旅程。
...
2. **OceanBase SeekDB设计和实现**: 介绍了OceanBase的设计和实现细节，这些细节对于理解OceanBase SeekDB的工作原理至关重要。
    在开始编写稍大的功能之前，你应该阅读以下内容，它可以帮助你更好地理解OceanBase SeekDB。
