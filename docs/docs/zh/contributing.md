...
* 通过[good first issue](https://github.com/oceanbase/oceanbase-seekdb/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)标签可以找到适合新手入门的issue
...
1. 访问项目的 [GitHub 地址](https://github.com/oceanbase/oceanbase-seekdb)。
2. 点击 Fork 按钮创建远程分支。
...
# 也可以使用: git clone https://github.com/$user/oceanbase-seekdb

# 添加上游分支
cd $working_dir/oceanbase
git remote add upstream git@github.com:oceanbase/oceanbase-seekdb.git
# 或: git remote add upstream https://github.com/oceanbase/oceanbase-seekdb
