...
1. **Get started**: Setting up the development environment, build and connect to the seekdb server, the subsections are based on an imagined newbie user journey.
...
3. **Contribute to OceanBase SeekDB**: helps you quickly get involved in the OceanBase community, which illustrates what contributions you can make and how to quickly make one.
