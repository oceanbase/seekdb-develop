...
TEST_F(TestCompactionPolicy, test_freeze_info_boundary_func)
{
  ...
  frozen_val.val_ = 100;
  ASSERT_EQ(OB_SUCCESS, freeze_infos.push_back(share::ObFreezeInfo(frozen_val, 1, DATA_VERSION_1_0_0_0)));
  frozen_val.val_ = 200;
  ASSERT_EQ(OB_SUCCESS, freeze_infos.push_back(share::ObFreezeInfo(frozen_val, 1, DATA_VERSION_1_0_0_0)));
  frozen_val.val_ = 300;
  ASSERT_EQ(OB_SUCCESS, freeze_infos.push_back(share::ObFreezeInfo(frozen_val, 2, DATA_VERSION_1_0_0_0)));
  frozen_val.val_ = 400;
  ASSERT_EQ(OB_SUCCESS, freeze_infos.push_back(share::ObFreezeInfo(frozen_val, 2, DATA_VERSION_1_0_0_0)));
  frozen_val.val_ = 500;
  ASSERT_EQ(OB_SUCCESS, freeze_infos.push_back(share::ObFreezeInfo(frozen_val, 2, DATA_VERSION_1_0_0_0)));
