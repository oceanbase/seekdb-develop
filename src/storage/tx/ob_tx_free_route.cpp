...
#endif
#define TX_START_OR_RESUME_ADDR(tx) ((tx)->addr_)
...
int ObTransService::calc_txn_free_route(ObTxDesc *tx, ObTxnFreeRouteCtx &ctx)
{
  ...
  bool is_xa_tightly_couple = false;
  ...
  audit_record.xa_tightly_couple_ = false;
#ifndef NDEBUG
