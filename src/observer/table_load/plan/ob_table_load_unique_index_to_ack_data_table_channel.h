...
namespace observer
{
class ObTableLoadUniqueIndexToAckDataTableChannel : public ObTableLoadTableChannel
{
public:
  ObTableLoadUniqueIndexToAckDataTableChannel(ObTableLoadTableOp *up_table_op,
                                              ObTableLoadTableOp *down_table_op)
    : ObTableLoadTableChannel(up_table_op, down_table_op)
  {
  }
  virtual ~ObTableLoadUniqueIndexToAckDataTableChannel() = default;
