...
namespace observer
{
class ObTableLoadUniqueIndexToDeleteDataTableChannel : public ObTableLoadTableChannel
{
public:
  ObTableLoadUniqueIndexToDeleteDataTableChannel(ObTableLoadTableOp *up_table_op,
                                                 ObTableLoadTableOp *down_table_op)
    : ObTableLoadTableChannel(up_table_op, down_table_op)
  {
  }
  virtual ~ObTableLoadUniqueIndexToDeleteDataTableChannel() = default;
